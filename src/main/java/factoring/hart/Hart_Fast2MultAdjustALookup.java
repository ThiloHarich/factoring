 ...
 */
public class Hart_Fast2MultAdjustALookup extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_Fast2MultAdjustALookup.class);
	 ...
	 */
	public Hart_Fast2MultAdjustALookup(boolean doTDivFirst) {
	...
	public long findSingleFactor(long N) {
		...
		try {
			for (int i=0; ; i++) {
				long k = kArr[i];
				a = (long) (sqrt4N *  sqrtKArr[i] + ROUND_UP_DOUBLE);
	...
	public static void main(String[] args) {
		...
		Hart_Fast2MultAdjustALookup holf = new Hart_Fast2MultAdjustALookup(false);
