 ...
 */
public class HartYSquareMultiplied extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(HartYSquareMultiplied.class);
...
//	private final TDiv63Inverse tdiv = new TDiv63Inverse(I_MAX);
	 ...
	 */
	public HartYSquareMultiplied (boolean doTDivFirst) {
