 ...
 */
public class Hart_Fast2MultSqrt extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_Fast2MultSqrt.class);
	...
	BitSet squaresMod255 = new BitSet();
	 ...
	 */
	public Hart_Fast2MultSqrt(boolean doTDivFirst) {
		...
		for (int i=0; i<127; ++i) {
			int squareMod = (i * i) % 255;
			squaresMod255.set(squareMod);
		}
	}
...
//		if (xMod255 != y)
//			System.out.println();
		final boolean possibleSquare = squaresMod255.get((int) y);
	...
	public static void main(String[] args) {
		...
		Hart_Fast2MultSqrt holf = new Hart_Fast2MultSqrt(false);
