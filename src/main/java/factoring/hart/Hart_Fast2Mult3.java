...
public class Hart_Fast2Mult3 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_Fast2Mult3.class);
	...
	private static final long K_MULT2 = 3465; // 3*3*5*7*11
	private static final long K_MULT1 = 315;  // 3*3*5*7
	 ...
	 */
	public Hart_Fast2Mult3(boolean doTDivFirst) {
	...
	public static void main(String[] args) {
		...
		Hart_Fast2Mult3 holf = new Hart_Fast2Mult3(false);
