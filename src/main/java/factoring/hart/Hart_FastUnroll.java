 ...
 */
public class Hart_FastUnroll extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Hart_FastUnroll.class);
	 ...
	 */
	public Hart_FastUnroll(boolean doTDivFirst) {
