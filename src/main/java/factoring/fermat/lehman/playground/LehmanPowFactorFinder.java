 ...
 */
public class LehmanPowFactorFinder implements FactorizationOfLongs {
	...
	public LehmanPowFactorFinder(int bits, float maxFactorMultiplierIn) {
		...
		final double nPow1Div3 = Math.pow(1L << bits, ONE_THIRD);
	...
	public long findFactors(long n, Collection<Long> primeFactors) {
		...
		final double nPow1Div6 = Math.pow(n, ONE_SIXTH);
		...
		final float nPow1Sixth = (float) (nPow1Div6 / 4);
