 ...
 */
public class LehmanReverseFact implements FactorizationOfLongs, FactorsFinder {
//	public class LehmanReverseFact extends FindPrimeFact {
	...
	protected void initSquares() {
		...
		final int kMax = (int) (maxTrialFactorMultiplier / maxFactorMultiplierCube);
	...
	public long findFactors(long n, Collection<Long> primeFactors) {
		...
		final long nPow2Third = ((long)maxTrialFactorMultiplier) * ((long)maxTrialFactorMultiplier);
