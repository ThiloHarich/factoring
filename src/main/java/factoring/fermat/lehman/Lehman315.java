 ...
 */
public class Lehman315 extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(Lehman315.class);
	 ...
	 */
	public Lehman315(boolean doTDivFirst) {
	...
	public long findSingleFactor(long N) {
		...
		if ((factor = testUpper(kTwoA, 8 *kLimit, sixthRootTerm, ks, sqrts, sqrtInvs)) > 1) return factor;
	...
	private long testUpper(int kTwoA, int kLimit, double sixthRootTerm, int[] ksx, double[] sqrtsx, double[] sqrtInvsx) {
		int i = kTwoA, k;
		long gcd;
	...
	public static void main(String[] args) {
		...
		final Lehman315 lehman = new Lehman315(false);
