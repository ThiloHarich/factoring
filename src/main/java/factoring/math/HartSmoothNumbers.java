 ...
 */
public class HartSmoothNumbers extends FactorAlgorithm {
	private static final Logger LOG = Logger.getLogger(HartSmoothNumbers.class);
	...
	private HashSet smoothNumbers = new HashSet();
	 ...
	 */
	public HartSmoothNumbers(boolean doTDivFirst) {
	...
	public long findSingleFactor(long N) {
		...
		try {
			for (int i=0; ; i++) {
				long k = kArr[i];
				final double aDouble = sqrt4N * sqrtKArr[i];
				a = (long) (aDouble + ROUND_UP_DOUBLE);
				long rest = a * a - k * fourN;
	...
	public static void main(String[] args) {
		...
		HartSmoothNumbers holf = new HartSmoothNumbers(false);
